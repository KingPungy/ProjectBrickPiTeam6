...
int main(int argc, char* argv[]) {
    ...
    */
    ...
    while (true) {
            ...
            } else if ((dotIO.redValue > 590 and dotIO.redValue < 630) and
                       (dotIO.greenValue > 340 and dotIO.greenValue < 380) and
                       (dotIO.blueValue > 190 and dotIO.blueValue < 230)){
                           std::cout << "Rode lijn stop nu!!!" << std::endl;
                           dotIO.dpsB(-50);
                           dotIO.dpsC(-50);
                        //    dotIO.steerPosition(0);
                           std::cout << "Stop dan!!!" << std::endl;
                           usleep(2000 * 1000);
                           dotIO.dpsB(0);
                           dotIO.dpsC(0);
                           std::cout << "Dan niet!!!" << std::endl;
                       }
                       usleep(100*1000);
    }
