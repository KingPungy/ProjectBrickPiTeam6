...
int main() {
    // BrickPi3_set_address(1, ""); // set BrickPi3 with any id to the default
    // address of 1 BrickPi3_set_address(7, "192A0F96514D4D5438202020FF080C23");
    ...
    char str[33];  // Room for the 32-character serial number string plus the
                   // NULL terminator.
